...
export const SERVER_KEY = "outline";
export const ENV_URL = "OUTLINE_URL";
export const ENV_TOKEN = "OUTLINE_API_TOKEN";
export const ENV_ALLOW_DELETE = "OUTLINE_ALLOW_DELETE";
